# ============================================================================
# CAREFLOW PULSE AGENT - TERRAFORM VARIABLES
# ============================================================================
...
#
# Description:
#   Input variables for CareFlow Pulse Agent infrastructure deployment.
# ============================================================================
...
variable "host_connection_name" {
  ...
  type        = string
  default     = "careflow-agent-github-connection"
}
...
variable "feedback_logs_filter" {
  ...
  default     = "jsonPayload.log_type=\"feedback\" jsonPayload.service_name=\"careflow-agent\""
}
