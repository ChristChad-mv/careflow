...
from ...careflow_agent.app.agent_other_model import root_agent 
from ...careflow_agent.app.app_utils.executor.careflow_executor import CareFlowAgentExecutor
...
async def run_audio_eval():
    ...
    print(f"Model: {root_agent.assistant.model}")
    print(f"─" * 60)
    ...
    for audio_path in audio_files:
        ...
        print(f"⌛ {root_agent.assistant.model} is listening...", end="", flush=True)
        ...
        with open(report_path, "w", encoding="utf-8") as rf:
            rf.write(f"# CareFlow Pulse - {root_agent.assistant.model} Agent Evaluation Report\n\n")
