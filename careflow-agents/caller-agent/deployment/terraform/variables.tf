# ============================================================================
# CAREFLOW CALLER AGENT - TERRAFORM VARIABLES
# ============================================================================
...
#
# Description:
#   Input variables for CareFlow Caller Agent infrastructure deployment.
# ============================================================================
...
variable "host_connection_name" {
  ...
  type        = string
  default     = "caller-agent-github-connection"
}
...
variable "feedback_logs_filter" {
  ...
  default     = "jsonPayload.log_type=\"feedback\" jsonPayload.service_name=\"caller-agent\""
}
